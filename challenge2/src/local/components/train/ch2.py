...
from challenge2.src.configs import CH2PipelineConfig, DiamondsDatasetConfig
...
from challenge2.src.utils.schemas.pipeline import TrainInput, TrainOutput
